;;; -*- Mode:Lisp; Lowercase:T; Syntax:Common-Lisp -*-
...
(defun contact-current-background-pixel (contact &optional (default-pixel :white))
  "Returns the current CONTACT background pixel, searching upward
   through the contact hierarchy to resolve :parent-relative.  If the
   search returns a non-pixel value, then the (converted) value of
   DEFAULT-PIXEL is returned."
